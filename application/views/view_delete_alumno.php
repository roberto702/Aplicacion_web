...
?><div id="container">
	...
	echo form_open();
	  ...
	  echo '<tr>';
	  echo "<td height='10' class='tabla_ventanas_login' height='10' colspan='3'><legend align='center'>Eliminar Información de ".$datos_alumnos_tabla[0]->nombre.' '.$datos_alumnos_tabla[0]->apellidos."</legend></td>";
	  echo '</tr>';
