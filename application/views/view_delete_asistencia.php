...
$input_con_id = array(
              'nombre_asistencia'        => $datos_asistencia[0]->nombre_clase,
            );
...
?><div id="container">
	...
	echo form_open();
	  ...
	  echo '<tr>';
	  echo "<td height='10' class='tabla_ventanas_login' height='10' colspan='3'><legend align='center'>Eliminar Información de ".$datos_asistencia[0]->nombre_clase.' '.$datos_asistencia[0]->nombre_alumno."</legend></td>";
	  echo '</tr>';
