...
$input_con_id = array(
              'rut_maestro'        => $datos_maestro[0]->rut_maestro,
            );
...
?><div id="container">
	...
	echo form_open();
	  ...
	  echo '<tr>';
	  echo "<td height='10' class='tabla_ventanas_login' height='10' colspan='3'><legend align='center'>Eliminar Información de ".$datos_maestro[0]->nombre_maestro."</legend></td>";
	  echo '</tr>';
